...
const _allNavItems = <NavItem>[
  NavItem(
    ...
    allowedRoles: ['admin', 'hr', 'manager', 'accountant', 'finance_manager', 'employee'],
  ...
  NavItem(
    ...
    allowedRoles: ['admin', 'hr', 'accountant', 'finance_manager', 'manager'],
    section: _hrSection,
  ...
  NavItem(
    ...
    allowedRoles: ['admin', 'hr'],
    section: _hrSection,
    keywords: ['forms', 'templates', 'letters', 'requests', 'hr forms'],
  ),
  NavItem(
    path: AppRoutes.approvals,
    label: 'Approvals',
    icon: Icons.approval_outlined,
    allowedRoles: ['admin', 'hr', 'manager', 'accountant', 'finance_manager'],
    section: _hrSection,
  ...
  NavItem(
    ...
    allowedRoles: ['admin', 'accountant', 'finance_manager'],
